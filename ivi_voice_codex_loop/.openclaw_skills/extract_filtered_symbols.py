"""
Skill: extract_filtered_symbols
Extracts symbols from a given text while excluding specific stop symbols and short unwanted symbols.
"""
...
def extract_filtered_symbols(text: str) -> List[str]:
    syms = []
